...
class KMeansVectorTest {
    ...
    void fit4Dimension() {
        ...
        double[][] dataset = new double[SIZE][DIMENSION];
        dataset[0] = new double[]{0, 0, 0, 0};
        dataset[1] = new double[]{0, 0, 0, 1};
        dataset[2] = new double[]{0, 0, 1, 0};
        dataset[3] = new double[]{0, 1, 0, 0};
        dataset[4] = new double[]{1, 0, 0, 0};
        dataset[5] = new double[]{-5, 0, 0, 0};
        dataset[6] = new double[]{0, -5, 0, 0};
        dataset[7] = new double[]{0, 0, -5, 0};
        dataset[8] = new double[]{0, 0, 0, -5};
        dataset[9] = new double[]{10, 0, 0, 0};
        dataset[10] = new double[]{0, 10, 0, 0};
        dataset[11] = new double[]{0, 0, 10, 0};
        dataset[12] = new double[]{0, 0, 0, 10};
        dataset[13] = new double[]{0, 20, 0, 0};
        dataset[14] = new double[]{0, 30, 0, 0};
        dataset[15] = new double[]{0, 40, 0, 0};
        dataset[16] = new double[]{0, 50, 0, 0};
        dataset[17] = new double[]{0, 100, 0, 0};
